...
export class SeedConfig {
  ...
  BOOTSTRAP_MODULE     = this.ENABLE_HOT_LOADING ? 'hot_loader_main' : 'components/main';

  APP_TITLE            = 'My Angular2 App';

  APP_SRC              = 'src';
  COMPONENTS_SRC       = `${this.APP_SRC}/components`;
  ASSETS_SRC           = `${this.APP_SRC}/assets`;
  SASS_SRC             = `${this.APP_SRC}/scss`;
  ...
  TMP_COMPONENTS       = `${this.DIST_DIR}/tmp/components`;
  APP_DEST             = `${this.DIST_DIR}/${this.ENV}`;
  COMPONENTS_DEST      = `${this.DIST_DIR}/${this.ENV}/components`;
